...
import { getLatestPosts, likeAPost,postAComment,deleteAComment, deleteACommentToMyPost } from "../controllers/postsController.js";
...
router.route("/delete-comment-to-my-post").delete(protect,deleteACommentToMyPost)
